...
class LoginController: UIViewController {
    ...
    private let cancelButton: ReusableButtons = {
    ...
    private let loginButton: ReusableButtons = {
        let button = ReusableButtons(type: .system)
    ...
    func configureUI() {
        ...
        topStack.anchor(top: view.safeAreaLayoutGuide.topAnchor, left: view.leftAnchor, bottom: nil, right: view.rightAnchor, paddingTop: 10, paddingLeft: 20, paddingBottom: 0, paddingRight: 20)
